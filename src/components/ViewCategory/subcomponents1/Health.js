  ...
  return (
    <>
      ...
      <section className='p-5'>
        ...
        <article className='d-flex flex-wrap justify-content-between mx-auto' style={{  maxWidth: '60%' }}>
          <Card  style={{ width: '27rem', borderRadius:'17px'}} className='mb-4'>
            <img src={vacunacion} alt ="" style={{width:"26.5rem"}}  className="photo"></img>
          ...
          <Card  style={{ width: '27rem', borderRadius:'17px'}} className='mb-4'>            
            <img src={cronograma} alt ="" style={{width:"26.5rem"}} className="photo"></img>
      ...
      <section className='p-5' style={{ background: '#ECF2F6'}}>
        ...
        <article className='d-flex flex-wrap justify-content-between mx-auto' style={{  maxWidth: '60%' }}>
        <Card style={{ width: '27rem', borderRadius:'17px'}} className='mb-4'>            
            <img src={recomendaciones} alt ="" style={{width:"26.5rem"}} className="photo"></img>
          ...
          <Card style={{ width: '27rem', borderRadius:'17px'}} className='mb-4'>
            <img src={recomendacion} alt ="" style={{width:"26.5rem"}}  className="photo"></img>
      ...
      <section className='p-5'>
        ...
        <Card  style={{ width: '27rem',  borderRadius:'17px'}} className='mb-4'>
          ...
          <Card  style={{ width: '27rem', borderRadius:'17px'}} className='mb-4'>            
            <img src={nutricion} alt ="" style={{width:"26.5rem"}} className="photo"></img>
